...
enum ActionModeSubStatesEnum {AS_BLASTER_MODE, AS_STUN_MODE, AS_MEGABLAST_MODE, AS_REPEATER_MODE, AS_FLAMETHROWER_MODE, AS_PLASMABLAST_MODE, AS_BLAST, AS_STUN, AS_MEGABLAST,AS_REPEATER,AS_FLAMETHROWER, AS_PLASMABLAST, AS_CLIPIN, AS_CLIPOUT, AS_EMPTY, AS_FULL, AS_MANUALRELOAD, AS_SWITCHOFF, AS_JAM, AS_UNJAM, AS_OVERHEAT, AS_PROFILECHANGE};
