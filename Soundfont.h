...
// MK4 has the full set, bar hum
    ...
    #define SF_EMPTY_OFFSET 16
    #define SF_RELOAD_OFFSET 17
    #define SF_JAM_OFFSET 18
    #define SF_UNJAM_OFFSET 19
...
// MK5 has the full set, plus hum and flamethrower
  ...
  const uint16_t getShot(uint8_t offset = 0) {
    #if defined V_MK1 or defined V_MK2 or defined V_MK3 or defined V_MK4 or defined V_MK5
  ...
  const uint16_t getJam(uint8_t offset = 0) {
    #if defined V_MK4 or defined V_MK5
    return NR_CONFIGFOLDERFILES + offset + SF_JAM_OFFSET + random(0,SF_JAM_NR);
    #endif
  }

  const uint16_t getUnjam(uint8_t offset = 0) {
    #if defined V_MK4 or defined V_MK5
   return NR_CONFIGFOLDERFILES + offset + SF_UNJAM_OFFSET + random(0,SF_UNJAM_NR);
    #endif
  }
